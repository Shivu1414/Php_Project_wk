...
$sql ="UPDATE postedjob set username='$name', email='$email', postlocation='$location', jobtitle='$jobtitle' WHERE sr='$sr' ";
...
?>
    ...
    <div class="container-fluid bg-muted p-0">
            ...
            <div class="col-lg-12 p-0">
                <nav class="navbar nav1 ">
                    <div class="div1">
                        ...
                        <div class="child2">
                            <a href="http://localhost/html/Work_PHP_Task/PUBLISH_UNPUBLISH_CARD/pubUnpubCard.php" class="link1">BACK</a>
                        </div>
                    </div>
                </nav>
            </div>
        ...
        <div class="div2 p-3">
            ...
            <form method="post" action="<?php echo htmlspecialchars($_SERVER[" PHP_SELF"]);?>" enctype="multipart/form-data" onsubmit="return cnfPubedit()">
            ...
            <div class="form-content">
                <input type="submit" name="submit" value="SUBMIT" class="preview bg-warning">
            </div>
            </form>
        </div>
    </div>
...
<script>
  function cnfPubedit(){
    return confirm("Did you really want to edit it?");
  }
</script> 
